...
define(function(require,expores,module){
    ...
    var activeIndex = 0;
    var t, loadTime;
    var animates = require('animate.js');
    var swuoerAbunate = require('swiper.animate1.0.2.min.js')
    var Swiper = require('swiper.min.js');
    var $ = require('jquery-1.7.2-min.js');
    var mp3Url = require('../mp3/octmami.mp3','image');
        ...
        var mySwiper = new Swiper('.swiper-container', {
            ...
            onLazyImageReady : function(swiper, slide, image){
                ...
                if(t==0){
                    swiper.unlockSwipes();
                    if(!loadTime){
                        swuoerAbunate.swiperAnimateCache(swiper);
                        swuoerAbunate.swiperAnimate(swiper);
